...
def get_image_to_emotion_predictor(model_path):
...
def model_evaluate():
    trainset = Fer2013Dataset(realpath('src/data/fer2013_train.npz'))
    testset = Fer2013Dataset(realpath('src/data/fer2013_test.npz'))
    net = Net().float()
